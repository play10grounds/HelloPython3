...
elif daytime == 'afternoon hours': result = '아침시간 (7-12)'
elif daytime == 'evening hours': result = '아침시간 (7-12)'
elif daytime == 'night hours': result = '아침시간 (7-12)'
elif daytime == 'midnight': result = '아침시간 (7-12)'
elif daytime == 'early morning hours': result = '아침시간 (7-12)'
elif daytime == 'small hours': result = '아침시간 (7-12)'
